...
const About = () => {
    return (
        ...
        <Card.Header  className='greetings' >Hi! I'm Mary. </Card.Header>
            <Card.Body> 
                I'm a recent graduate from Temple University with a BS in Computer Science. I'm very excited to start my career in front-end development,
                and I made this W.I.P. portfolio to showcase my skills.
            </Card.Body>
            <Card.Body>
